...
public class ArquivosMB implements Serializable {
	...
	/**
	 * Gets the selected cars.
	 * 
	 * @return the selected cars
	 */
	...
	/**
	 * Gets the palavras chave.
	 * 
	 * @return the palavras chave
	 */
	...
	/**
	 * Sets the palavras chave.
	 * 
	 * @param palavrasChave
	 *            the new palavras chave
	 */
	...
	public void removePalavraChave(String palavra) {
		if (!palavra.isEmpty()
				&& this.palavrasChave.contains(palavra.toLowerCase())) {
